    ...
    public function run(): void
    {
        ...
        $topics = [
            [
                ...
                'slug' => 'cultural',
                'short_description' => 'The study of cultural variation among humans.',
                'icon' => 'groups',
                'color' => '#9a3412',
            ],
            [
                ...
                'slug' => 'social',
                'short_description' => 'How people live in social groups and the ways they make their lives meaningful.',
                'icon' => 'diversity_3',
                'color' => '#1e293b',
            ],
            [
                ...
                'slug' => 'biological',
                'short_description' => 'Human biological and physiological characteristics and their evolution.',
                'icon' => 'dna',
                'color' => '#166534',
            ],
            [
                ...
                'slug' => 'linguistic',
                'short_description' => 'How language influences social life and human culture.',
                'icon' => 'translate',
                'color' => '#0369a1',
            ],
            [
                'name' => 'Archaeology',
                'slug' => 'archaeology',
                'short_description' => 'The study of human activity through the recovery and analysis of material culture.',
                'icon' => 'architecture',
                'color' => '#854d0e',
            ],
            [
                ...
                'slug' => 'medical',
                'short_description' => 'Human health and disease, health care systems, and biocultural adaptation.',
            ...
            [
                ...
                'slug' => 'political',
                'short_description' => 'Structures of political power and governance in human societies.',
            ...
            [
                ...
                'slug' => 'digital',
                'short_description' => 'Human-technology interactions and digital cultural manifestations.',
                'icon' => 'devices',
                'color' => '#6b21a8',
            ],
        ];
