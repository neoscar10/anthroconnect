<a href="{{ route('encyclopedia.concepts.show', $concept->slug) }}" class="p-6 rounded-[24px] bg-white dark:bg-stone-900 border border-stone-200 dark:border-stone-800 shadow-sm hover:border-primary/40 hover:shadow-xl hover:-translate-y-1 transition-all group cursor-pointer flex flex-col h-full">
